...
def generate_strands(component_list, full_strand_recipe):
    ...
    while attempts < 100:
        ...
        for index in range(0, len(component_list)):
            ...
            seq = gen_string(component['length'], component['blueprint'], component['complement'], front_edges[0], front_edges[1])
...
"""
a = {'name':'a', 'length':15, 'blueprint':"", 'complement':True, 'sequence':''}
b = {'name':'b', 'length':15, 'blueprint':"", 'complement':True, 'sequence':''}
